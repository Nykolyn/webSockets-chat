...
},{"./url":"node_modules/socket.io-client/lib/url.js","socket.io-parser":"node_modules/socket.io-parser/index.js","./manager":"node_modules/socket.io-client/lib/manager.js","debug":"node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"node_modules/socket.io-client/lib/socket.js"}],"src/js/functions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.userDisconecting = exports.handleMsgTyping = exports.clearIsTyping = exports.showIsTyping = exports.showOnlineUsers = exports.handleMsgSubmit = exports.appendMsgToChat = exports.showDisconectedUser = exports.handleLogin = exports.showLoggedName = void 0;
...
var showLoggedName = function showLoggedName(name) {
  _app.refs.usersActions.insertAdjacentHTML("beforeend", "<li><p>User ".concat(name, " connected</p></li>"));

  _app.socket.emit("users-online"); // setTimeout(() => {
  //   refs.usersActions.innerHTML = "";
  // }, 2000);

};

exports.showLoggedName = showLoggedName;

var handleLogin = function handleLogin(e) {
  e.preventDefault();

  var _e$currentTarget$elem = _slicedToArray(e.currentTarget.elements, 1),
      name = _e$currentTarget$elem[0];

  _app.socket.emit("login", name.value);

  _app.socket.emit("users-online");

  userName = name.value;

  _app.refs.loginPage.classList.add("hide");
};

exports.handleLogin = handleLogin;

var showDisconectedUser = function showDisconectedUser(name) {
  _app.refs.usersActions.insertAdjacentHTML("beforeend", "<p>User ".concat(name, " is out, its even better without him... </p>"));
};

exports.showDisconectedUser = showDisconectedUser;

var appendMsgToChat = function appendMsgToChat(_ref) {
  var name = _ref.name,
      msg = _ref.msg;

  _app.refs.messagesList.insertAdjacentHTML("afterbegin", "<li>".concat(name, ": ").concat(msg, ", ").concat(new Date().toLocaleTimeString(), "<li>"));
};

exports.appendMsgToChat = appendMsgToChat;

var handleMsgSubmit = function handleMsgSubmit(e) {
  e.preventDefault();

  var _e$currentTarget$elem2 = _slicedToArray(e.currentTarget.elements, 1),
      message = _e$currentTarget$elem2[0];
  ...
  _app.socket.emit("chat-message", msgToAdd);
};

exports.handleMsgSubmit = handleMsgSubmit;

var showOnlineUsers = function showOnlineUsers(users) {
  _app.refs.usersOnline.innerHTML = users.length;
};

exports.showOnlineUsers = showOnlineUsers;

var showIsTyping = function showIsTyping(name) {
  console.log("show typing");
  if (document.querySelector(".".concat(name))) return;

  _app.refs.isTyping.insertAdjacentHTML("afterbegin", "<p class=\"".concat(name, "\">User ").concat(name, " is typing...</p>"));
};

exports.showIsTyping = showIsTyping;

var clearIsTyping = function clearIsTyping(name) {
  console.log("clearTyping");
  var elToClear = document.querySelector(".".concat(name));
  elToClear.remove();
};

exports.clearIsTyping = clearIsTyping;

var handleMsgTyping = function handleMsgTyping(_ref2) {
  var value = _ref2.target.value;
  console.log(value);
  if (value !== "") return _app.socket.emit("is-typing", userName);
  if (value === "") return _app.socket.emit("clear-typing", userName);
};

exports.handleMsgTyping = handleMsgTyping;

var userDisconecting = function userDisconecting(e) {
  e.preventDefault();
  console.log("are you sure");

  _app.socket.emit("user-disconnecting", userName);

  _app.socket.emit("users-online");
};

exports.userDisconecting = userDisconecting;
},{"./app":"src/js/app.js"}],"src/js/app.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.refs = exports.socket = void 0;
...
var socket = (0, _socket.default)("ws://localhost:3004");
...
},{"socket.io-client":"node_modules/socket.io-client/lib/index.js","./functions":"src/js/functions.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

require("./js/app");
},{"./js/app":"src/js/app.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5131" + '/');
